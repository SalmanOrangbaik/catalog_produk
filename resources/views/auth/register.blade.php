                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            <div class="brand-logo">
                                <img src="{{ asset('assets/images/abfa2e98-725d-457b-83e8-a1b73a43854f-removebg-preview.png') }}"
                                    style="max-width: 19%; ">
                            </div>
                            <h4>Daftar</h4>
                            <form class="pt-3">
                                ...
                                <div class="mt-3">
                                    <button class="btn d-grid btn-primary btn-lg font-weight-medium auth-form-btn"
                                        href="('index.html" style="width: 100%">Mendaftar</button>
                                </div>
                                <div class="text-center mt-4 font-weight-light"> Sudah Punya Akun? <a href="login.html"
