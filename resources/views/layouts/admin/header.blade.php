<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          <a class="navbar-brand brand-logo-mini" href="home"><img src="{{asset('assets/images/abfa2e98-725d-457b-83e8-a1b73a43854f-removebg-preview.png')}}" style="max-width: 90px;" alt="logo" /></a>
